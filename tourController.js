...
export const updateTour = async(req,res)=>{
    ...
    try{
        ...
        res
        .status(200)
        .json({ success: true, message: 'Successfully updated', data: updateTour })
...
export const getSingleTour = async(req,res)=>{
    ...
    try{
        ...
        res
        .status(404)
        .json({ success: false, message: 'failed to find'});
    }
};
...
export const getTourBySearch = async(req,res)=>{
    ...
    try{
        const tours = await Tour.find({ city, distance:{$lte:distance},
        maxGroupSize:{$gte:maxGroupSize}}).populate("reviews");

        res
        .status(200)
        .json({ success: true, message: 'Successfully updated', data: tours })   
...
export const getFeaturedTours = async(req,res)=>{
    try{
        ...
        res
        .status(200)
        .json({ success: true, message: 'Successful', data: tours});
